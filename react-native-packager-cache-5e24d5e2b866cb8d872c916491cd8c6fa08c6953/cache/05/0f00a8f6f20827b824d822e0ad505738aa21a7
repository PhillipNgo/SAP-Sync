...
var _Polygon = require('./elements/Polygon');

var _Polygon2 = babelHelpers.interopRequireDefault(_Polygon);

var _Polyline = require('./elements/Polyline');
...
var _TextPath = require('./elements/TextPath');

var _TextPath2 = babelHelpers.interopRequireDefault(_TextPath);

var _Use = require('./elements/Use');
...
var _ClipPath = require('./elements/ClipPath');
